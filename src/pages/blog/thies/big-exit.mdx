...
<Badge type="error">Warning: Sources partially unavailable due to account deletion</Badge>
> <Badge type="info">Note</Badge>
> Some of the tweets that were shown in this article, so that I had to remove them.
